...
2. Toplanan Veriler
Uygulama, iş süreçlerinin yürütülmesi amacıyla aşağıdaki verileri toplayabilir:
•
Kişisel Bilgiler: Ad, Soyad, Sicil Numarası, Doğum Tarihi, E-posta adresi.
•
Operasyonel Veriler: Kalıp bakım kayıtları, üretim formları, arıza raporları.
•
Medya: Sohbet kısmında paylaşılan fotoğraflar ve videolar.
•
Cihaz Bilgileri: Bildirim gönderimi için Firebase cihaz kimliği (token).
3. Verilerin Kullanım Amacı
Toplanan veriler sadece; personel yetkilendirme, üretim süreçlerinin anlık takibi, kalıp bakım yönetimi ve önemli operasyonel bilgilendirmeler için kullanılır.
4. Veri Güvenliği ve Yasal Sorumluluk
Verileriniz Firebase (Google) altyapısında şifrelenmiş olarak saklanmaktadır.
[!CAUTION] YASAL UYARI: Uygulama içerisinde yer alan üretim verileri, personel bilgileri ve ticari sırlar kurumun mülkiyetindedir. Bu verilerin yetkisiz kişilerle paylaşılması, kopyalanması, dışarı sızdırılması veya kötüye kullanılması 6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK) ve Türk Ceza Kanunu kapsamında suç teşkil etmektedir. Bu tür eylemlerde bulunan kullanıcılar hakkında yasal işlem başlatılacaktır.
5. Veri Paylaşımı
Verileriniz, yasal zorunluluklar haricinde hiçbir üçüncü taraf kişi veya kurumla ticari amaçlarla paylaşılmaz.
6. İletişim
